...
<div class="main-container">
    ...
    <h2 class="page-title">Dashboard Admin Aplikasi Disiplin <?php echo htmlspecialchars($data['nama_sekolah']); ?></h2>
    
    <!-- Contoh Tampilan Dashboard / Ringkasan Data -->
    <div class="dashboard-grid">
        <div class="card">
            <h3>Manajemen User</h3>
            <p>Menu untuk mengubah password, menambah/mengubah/menghapus user</p>
            <a href="manajemen_user.php">
    <button type="submit">Manajemen User</button>
</a>
        </div>
        <div class="card">
            <h3>Pengaturan</h3>
            <p>Menu untuk pengaturan identitas sekolah, semester, tahun pelajaran dan lain-lain</p>
                    <a href="pengaturan.php">
    <button type="submit">Pengaturan</button>
</a>
        </div>
    </div>
        <div class="dashboard-grid">
        <div class="card">
            ...
            <p>Menu untuk mengupload, menghapus, dan menambahkan data siswa</p>
            <a href="upload_siswa.php">
    <button type="submit">Upload/Hapus/Tambah Data Siswa</button>
</a>
        </div>
        <div class="card">
            <h3>Hapus Catatan</h3>
            <p>Menu untuk menghapus seluruh data pencatatan disiplin siswa</p>
            <a href="reset_catat.php">
    <button type="submit">Bersihkan data Pencatatan</button>
</a>
        </div>
    </div>
